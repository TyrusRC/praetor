...
echo
echo " Loaded a PREVIOUS build? REMOVE the entry in Extensions -> Installed, then Add this jar again."
echo " (untick/re-tick only reloads the same in-memory jar; it does NOT re-read a rebuilt file.)"
