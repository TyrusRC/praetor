...
class RenderScreenshotTest(unittest.TestCase):
    def test_client_report_embeds_image(self):
        out = build_finding_section(_finding(), 1, internal=False)
        self.assertIn("_PoC screenshots:_", out)
        # inline image embed with a viewer-renderable relative ref + caption
    ...
    def test_step_prefix_rendered(self):
        ...
        self.assertIn("![Step 2-attack: id=2 -> victim order](../screenshots/burp-repeater-x.png)", out)
