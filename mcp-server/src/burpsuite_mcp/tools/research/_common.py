"""Shared research-bundle constants — vuln-class KB + methodology deep-links.

Kept module-local so each backend submodule stays a one-liner and the
`register` submodule pulls everything from one place.
"""
