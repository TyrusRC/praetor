...
from praetor.tools.notes._helpers import _findings_lock
...
ATTACK_MAP: dict[str, tuple[str, str, str]] = {
    ...
    "pywhisker": ("Credential Access", "T1649", "Steal or Forge Authentication Certificates"),
    "getuserspns": ("Credential Access", "T1558.003", "Kerberoasting"),
    "getnpusers": ("Credential Access", "T1558.004", "AS-REP Roasting"),
    "dpapi": ("Credential Access", "T1555", "Credentials from Password Stores"),
    "changepasswd": ("Persistence", "T1098", "Account Manipulation"),
    "net": ("Persistence", "T1098", "Account Manipulation"),
    "runascs": ("Privilege Escalation", "T1134.002", "Create Process with Token"),
    "certutil": ("Command and Control", "T1105", "Ingress Tool Transfer"),
    "mssqlclient": ("Lateral Movement", "T1210", "Exploitation of Remote Services"),
    "rubeus": ("Credential Access", "T1558", "Steal or Forge Kerberos Tickets"),
    "getst": ("Credential Access", "T1558", "Steal or Forge Kerberos Tickets"),
    "ticketconverter": ("Credential Access", "T1558", "Steal or Forge Kerberos Tickets"),
    "ticketer": ("Credential Access", "T1558.001", "Golden Ticket"),
    "petitpotam": ("Credential Access", "T1187", "Forced Authentication"),
    "printerbug": ("Credential Access", "T1187", "Forced Authentication"),
    "dfscoerce": ("Credential Access", "T1187", "Forced Authentication"),
    "coercer": ("Credential Access", "T1187", "Forced Authentication"),
    "krbrelayx": ("Credential Access", "T1557.001", "LLMNR/NBT-NS Poisoning and SMB Relay"),
    "nltest": ("Discovery", "T1482", "Domain Trust Discovery"),
    "raisechild": ("Privilege Escalation", "T1134.005", "SID-History Injection"),
    "bloodyad": ("Persistence", "T1098", "Account Manipulation"),
    "rusthound": ("Discovery", "T1069", "Permission Groups Discovery"),
    "rusthound-ce": ("Discovery", "T1069", "Permission Groups Discovery"),
    "targetedkerberoast": ("Credential Access", "T1558.003", "Kerberoasting"),
    "gmsadumper": ("Credential Access", "T1555", "Credentials from Password Stores"),
