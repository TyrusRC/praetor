"""Implementation for oauth_flow_simulator — split from oauth_flow.py to keep the
tool wrapper thin. The wrapper in oauth_flow.py owns the @mcp.tool() signature +
