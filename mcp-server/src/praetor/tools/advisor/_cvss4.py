"""CVSS 4.0 vector builder + categorical scorer (W7, T6). Logic; tables in _cvss4_data."""

from __future__ import annotations

from typing import Any

from ._cvss4_data import (  # noqa: F401
    CVSS4_PREFIX,
    _BASE_METRICS, _BASE_REQUIRED, _OPTIONAL_METRICS, _VALID_METRICS,
