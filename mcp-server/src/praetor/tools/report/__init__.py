...
from praetor.tools.report.builders import (
...
from praetor.tools.report.severity import severity_sort_key
from praetor.tools.report import completion_judge  # noqa: F401 — W37-B: binds submodule for server.register
...
def register(mcp: FastMCP):
    ...
    async def generate_report(
        ...
        if format == "pentest":
            ...
            sections.append("")
            sections.append("---")
            sections.append(f"*Generated by Praetor — {now}*")
