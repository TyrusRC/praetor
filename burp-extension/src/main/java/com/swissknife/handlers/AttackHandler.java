...
import com.swissknife.attack.AuthMatrixHandler;
import com.swissknife.attack.HppHandler;
import com.swissknife.attack.RaceHandler;
 ...
 * collaborator in {@link com.swissknife.attack}:
 *
 *   /api/attack/auth-matrix -> AuthMatrixHandler
 *   /api/attack/race        -> RaceHandler
 *   /api/attack/hpp         -> HppHandler
 *
 * Session state is read via {@link com.swissknife.store.SessionStore} singleton
