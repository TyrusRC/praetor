...
public class DashboardPanel extends JPanel {
    ...
    private void buildUi(String host, int port, String version,
        ...
        findingsTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    if (row >= 0) DashboardActions.showFindingDetail(DashboardPanel.this, findingsModel, findingsStore, row);
                }
            }
        });
        ...
        exportOpenApi.addActionListener(e -> DashboardActions.exportOpenApiToFile(this, serverHost, serverPort, this::log));
        ...
        exportReport.addActionListener(e -> DashboardActions.exportFindingsReport(this, findingsStore, this::log));
