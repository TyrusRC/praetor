...
import com.praetor.http.HttpHandler;
...
public abstract class BaseHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            com.praetor.ui.ConfigTab.log("BAD_JSON: " + path + " -> " + e.getMessage());
            sendError(exchange, 400,
                "Malformed JSON body: " + e.getMessage(),
                "validation_failed",
                "Verify the request body is valid JSON before retrying.");
        } catch (Exception e) {
            com.praetor.ui.ConfigTab.log("ERROR: " + path + " -> " + e.getMessage());
