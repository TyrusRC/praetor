...
public class NotesHandler extends BaseHandler {
    ...
    private void handleSave(HttpExchange exchange) throws Exception {
        ...
        if (com.praetor.store.FindingsStore.isNeverSubmit(vulnType, title)) {
        ...
        if (hasCollab) {
            ...
            Boolean known = com.praetor.collaborator.CollaboratorPool
        ...
        // Python's _deduplicate_finding handles persistent dedup in .burp-intel/.
